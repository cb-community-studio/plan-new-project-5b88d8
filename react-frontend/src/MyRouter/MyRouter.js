...
import ArraytestPage from "../components/ArraytestPage/ArraytestPage";
import SingleArraytestPage from "../components/ArraytestPage/SingleArraytestPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/arraytest" component={ArraytestPage} exact />
                    <Route path="/arraytest/:singleArraytestId" component={SingleArraytestPage} exact />
                    {/* ~cb-add-route~ */}
